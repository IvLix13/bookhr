...
class NotificationRule(db.Model, TimestampMixin):
    ...
    recipient_user_id = db.Column(db.String(128), nullable=True)
    recipient_display_name = db.Column(db.String(256), nullable=True)
    ...
    escalation_recipient_user_id = db.Column(db.String(128), nullable=True)
    escalation_recipient_display_name = db.Column(db.String(256), nullable=True)
